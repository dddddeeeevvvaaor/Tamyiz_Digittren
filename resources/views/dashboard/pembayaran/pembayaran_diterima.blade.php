...
<div class="container-fluid" style="background-color: #F7F6F6; padding: 15px; border-radius: 15px;">
    ...
    <div class="card shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Pembayaran Di Terima</h5>
    ...
    <script>
        function changePerPage() {
            ...
            window.location.href = `{{ url('/dashboard/pembayaran/pembayaran_diterima?perPage=${perPage}') }}`;
        }
    ...
    <div class="card shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Pembayaran Infaq Di Terima</h5>
            <!-- Card tools untuk aksi seperti import dan export -->
            <div class="card-tools">
            </div>
            <!-- Modal import  -->
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped text-center">
                    ...
                    <tbody>
                        ...
                        @if($infaq_perbulan['status'] == 1) <!-- Menampilkan hanya status pembayaran yang diterima -->
                        <tr>
                            <td>{{ $loop->iteration }}</td>
                            ...
                            <td>
                                <a href="{{ route('bukti_infaq', $infaq_perbulan->nist) }}">Lihat</a>
                            </td>
                            <td>
                                <a href="{{ route('detail.pendaftaran', $infaq_perbulan->nist) }}">Detail</a>
                            </td>
                            <td style="vertical-align: middle;">
                                <p style="color: green; margin: 0;">Diterima</p>
                            </td>
    ...
    <script>
        function changePerPageInfaq() {
            ...
            window.location.href = `{{ url('/dashboard/pembayaran/pembayaran_diterima?perPageInfaq=${perPageInfaq}') }}`;
        }
